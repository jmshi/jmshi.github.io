...
In this proposal, I will demonstrate the possibility to use Twitter to (1) make very efficient and productive survey in the mobile game business, and (2) perform detailed analysis on given product (here use Pokemon Go as an example) to find out important information such as hot terms/topic, product usage patterns, and the customer sentiment of the product. The analysis can be found in this [notebook](https://nbviewer.jupyter.org/gist/jmshi/a90c1651b857aad55e06796113d67b97).
